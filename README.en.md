...
> Updated **2026-09-22T03:22:55Z** · **261** related repositories · **85,688** total repository stars
...
| :-- | :-- | --: | :-- |
| 🥇 [browser-use/jev-ultrafast](https://github.com/browser-use/jev-ultrafast) | Apps / integrations | **16,160** | Browser agent using Jev to choose page actions alongside a text-generation model. |
| 🥈 [OpenByteInc/QuantDinger](https://github.com/OpenByteInc/QuantDinger) | Apps / integrations | **11,956** | Open-source AI Trading OS, agent trading, and vibe trading, with Jev System One integration. Resear… |
| 🥉 [NandhaKishorM/laya](https://github.com/NandhaKishorM/laya) | Independent research | **11,192** | Independent open decision model with training and evaluation materials; not TypeSafe Jev. |
| 4 [tamaratran/fast-jev-compaction](https://github.com/tamaratran/fast-jev-compaction) | Tools | **6,022** | Claude Code compaction plugin using Jev to select tool records worth retaining. |
| 5 [TheoLeeCJ/SemIf](https://github.com/TheoLeeCJ/SemIf) | Independent research | **3,329** | Semantic decisions from open models, formerly OpenJev; independent of TypeSafe. |
| 6 [jaredpalmer/kev](https://github.com/jaredpalmer/kev) | Independent research | **2,579** | Independent Jev-like decision models built on Qwen3.5; not the official Jev model. |
| 7 [jarrodwatts/jev-trader](https://github.com/jarrodwatts/jev-trader) | Apps / integrations | **1,872** | One AI trade decision every Monad block. Jev on Kuru MON-USDC. |
| 8 [TianyuCodings/NanoJev](https://github.com/TianyuCodings/NanoJev) | Independent research | **1,840** | Independent small-scale reproduction with parallel decisions and a training pipeline. |
| 9 [typesafe-ai/skills](https://github.com/typesafe-ai/skills) | Official | **1,585** | Official agent skills for building System One decision workflows. |
| 10 [jev-chat/jev-chat-jarvis](https://github.com/jev-chat/jev-chat-jarvis) | Apps / integrations | **1,491** | Mobile chat assistant using Jev for intent and risk judgments; Chinese documentation. |
| 11 [vinnylarouge/jevlike](https://github.com/vinnylarouge/jevlike) | Independent research | **1,170** | Independent Jev-like model training experiment for probabilities over dynamic choices; not official… |
| 12 [yibie/awesome-jev](https://github.com/yibie/awesome-jev) | Resources | **1,016** | Community directory of Jev projects, integrations and discussions. |
...
| 14 [awlevin/typesafe-computer-use](https://github.com/awlevin/typesafe-computer-use) | Apps / integrations | **760** | macOS automation combining screen OCR with Jev action selection. |
...
| 20 [devagrawal09/jev-review](https://github.com/devagrawal09/jev-review) | Tools | **499** | Staged code review with Jev and a local results dashboard. |
| 21 [rmalde/minecraft-agent](https://github.com/rmalde/minecraft-agent) | Apps / integrations | **481** | Astra planner and JEV controller for Minecraft, with native recording, tested routes, and run verif… |
| 22 [thruwire/foreman](https://github.com/thruwire/foreman) | Apps / integrations | **469** | Software factory foreman based on TypeSafe's Jev model |
| 23 [featherless-ai/simple-jev](https://github.com/featherless-ai/simple-jev) | Independent research | **458** | Independent implementation exposing open models as classifiers and Jev-style endpoints. |
...
| 26 [kerpopule/hermes-jev-skills](https://github.com/kerpopule/hermes-jev-skills) | Tools | **400** | Jev-powered model routing, memory, compaction, skill selection, computer and browser use for Hermes… |
...
| 28 [wuyoscar/jev-skill](https://github.com/wuyoscar/jev-skill) | Resources | **375** | An awesome collection of Jev use cases, workflows, and agent skills. |
| 29 [wfzyx/von](https://github.com/wfzyx/von) | Independent research | **371** | Independent open decision model with a TypeSafe-compatible API; not official Jev. |
...
updated · Last successful fetch: 2026-09-22T03:22:56Z
...
| [Show HN: jevals – replacing LLM judges with typed Jev decisions](https://news.ycombinator.com/item?id=49780849) | 42 | 1 |
| [Jev: The Model That Gives AI the Properties of Code](https://news.ycombinator.com/item?id=49716682) | 18 | 4 |
| [We Tested Jev on 100 Agent Tool Calls](https://news.ycombinator.com/item?id=49788402) | 11 | 0 |
...
updated · Last successful fetch: 2026-09-22T03:22:59Z
...
| [vagmi/jev-lite](https://huggingface.co/vagmi/jev-lite) | 5 | 28 |
| [samatv256/mini-Jev](https://huggingface.co/samatv256/mini-Jev) | 3 | 20 |

### News / articles

updated · Last successful fetch: 2026-09-22T03:23:00Z
...
- jev in:name,description fork:false archived:false stars:&gt;=2 — 200 / 1063 (page cap reached)
- topic:jev fork:false archived:false — 200 / 1096 (page cap reached)
- jev typesafe in:readme fork:false archived:false stars:&gt;=5 — 200 / 835 (page cap reached)
