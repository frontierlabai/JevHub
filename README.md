...
> 更新于 **2026-09-22T03:22:55Z** · **261** 个相关仓库 · **85,688** 个累计 Star
...
| 项目 | 类别 | ⭐ Stars | 一句话介绍 |
| :-- | :-- | --: | :-- |
| 🥇 [browser-use/jev-ultrafast](https://github.com/browser-use/jev-ultrafast) | 应用 / 集成 | **16,160** | 浏览器 Agent：由 Jev 选择页面操作，结合文本生成模型完成任务。 |
| 🥈 [OpenByteInc/QuantDinger](https://github.com/OpenByteInc/QuantDinger) | 应用 / 集成 | **11,956** | Open-source AI Trading OS, agent trading, and vibe trading, with Jev System One integration. Resear… |
| 🥉 [NandhaKishorM/laya](https://github.com/NandhaKishorM/laya) | 独立复现 / 研究 | **11,192** | 独立开放决策模型，提供训练与评测材料；非 TypeSafe 官方模型。 |
| 4 [tamaratran/fast-jev-compaction](https://github.com/tamaratran/fast-jev-compaction) | 开发工具 | **6,022** | Claude Code 上下文压缩插件：Jev 判断哪些工具记录仍需保留。 |
| 5 [TheoLeeCJ/SemIf](https://github.com/TheoLeeCJ/SemIf) | 独立复现 / 研究 | **3,329** | 用开放模型实现语义判断，原名 OpenJev；项目明确声明与 TypeSafe 无关联。 |
| 6 [jaredpalmer/kev](https://github.com/jaredpalmer/kev) | 独立复现 / 研究 | **2,579** | 基于 Qwen3.5 的独立 Jev-like 决策模型，可自行训练；非官方模型。 |
| 7 [jarrodwatts/jev-trader](https://github.com/jarrodwatts/jev-trader) | 应用 / 集成 | **1,872** | One AI trade decision every Monad block. Jev on Kuru MON-USDC. |
| 8 [TianyuCodings/NanoJev](https://github.com/TianyuCodings/NanoJev) | 独立复现 / 研究 | **1,840** | 独立小型复现：并行决策、动态候选与训练流程；非官方模型。 |
| 9 [typesafe-ai/skills](https://github.com/typesafe-ai/skills) | 官方项目 | **1,585** | 官方 Agent skills：设计和构建 System One 决策工作流。 |
| 10 [jev-chat/jev-chat-jarvis](https://github.com/jev-chat/jev-chat-jarvis) | 应用 / 集成 | **1,491** | 中文手机聊天助手：Jev 判断意图和风险，辅助选择回复。 |
| 11 [vinnylarouge/jevlike](https://github.com/vinnylarouge/jevlike) | 独立复现 / 研究 | **1,170** | 独立 Jev-like 模型训练实验：对动态候选输出概率；非 TypeSafe 官方模型。 |
| 12 [yibie/awesome-jev](https://github.com/yibie/awesome-jev) | 资源合集 | **1,016** | 社区维护的 Jev 项目、集成与讨论索引。 |
| 13 [Anil-matcha/awesome-jev-by-typesafe](https://github.com/Anil-matcha/awesome-jev-by-typesafe) | 资源合集 | **766** | Evidence-backed use cases, patterns, prompts, and starter code for TypeSafe Jev — a System One mode… |
| 14 [awlevin/typesafe-computer-use](https://github.com/awlevin/typesafe-computer-use) | 应用 / 集成 | **760** | macOS 桌面自动化：OCR 识别屏幕，Jev 选择下一步操作。 |
| 15 [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) | 开发工具 | **752** | Biologically-inspired memory for AI agents. Decay, retrieval strengthening, consolidation. Zero run… |
| 16 [samuelfaj/distill](https://github.com/samuelfaj/distill) | 开发工具 | **683** | 编程 Agent harness 与终端界面，提供 Jev 任务路由。 |
| 17 [milind-soni/tiptour-macos](https://github.com/milind-soni/tiptour-macos) | 应用 / 集成 | **640** | macOS 桌面助手：Jev 根据本地识别的控件文字与位置选择点击操作。 |
| 18 [v-modal/awesome-jev-tools](https://github.com/v-modal/awesome-jev-tools) | 资源合集 | **628** | A curated list of tools built for Jev — TypeSafe AI's System One model for typed decisions. |
| 19 [Sac-Y/Jev-cu](https://github.com/Sac-Y/Jev-cu) | 开发工具 | **547** | Codex Computer Use skill：Jev 从界面文字中选择操作，本地规则控制执行。 |
| 20 [devagrawal09/jev-review](https://github.com/devagrawal09/jev-review) | 开发工具 | **499** | 基于 Jev 的分阶段代码审查与本地结果面板。 |
| 21 [rmalde/minecraft-agent](https://github.com/rmalde/minecraft-agent) | 应用 / 集成 | **481** | Astra planner and JEV controller for Minecraft, with native recording, tested routes, and run verif… |
| 22 [thruwire/foreman](https://github.com/thruwire/foreman) | 应用 / 集成 | **469** | Software factory foreman based on TypeSafe's Jev model |
| 23 [featherless-ai/simple-jev](https://github.com/featherless-ai/simple-jev) | 独立复现 / 研究 | **458** | 将开放模型转换为分类器与 Jev 风格接口；独立实现。 |
| 24 [AbdelStark/awesome-typesafe-jev](https://github.com/AbdelStark/awesome-typesafe-jev) | 资源合集 | **431** | Awesome Jev: a source-backed field guide to TypeSafe's System One model, with SDKs, live demos, age… |
| 25 [notque/vexjoy-agent](https://github.com/notque/vexjoy-agent) | 开发工具 | **423** | VexJoy AI Agent with Jev Intelligent Routing - /do routes plain-English requests to the right speci… |
| 26 [kerpopule/hermes-jev-skills](https://github.com/kerpopule/hermes-jev-skills) | 开发工具 | **400** | Jev-powered model routing, memory, compaction, skill selection, computer and browser use for Hermes… |
| 27 [superagents-lab/jev-search](https://github.com/superagents-lab/jev-search) | 应用 / 集成 | **382** | Jev 理解查询、选择信息源并重排搜索结果。 |
| 28 [wuyoscar/jev-skill](https://github.com/wuyoscar/jev-skill) | 资源合集 | **375** | An awesome collection of Jev use cases, workflows, and agent skills. |
| 29 [wfzyx/von](https://github.com/wfzyx/von) | 独立复现 / 研究 | **371** | 独立开放决策模型，提供 TypeSafe API 兼容接口；非官方模型。 |
| 30 [dabit3/jev-experiments](https://github.com/dabit3/jev-experiments) | 应用 / 集成 | **358** | 暂无简介；可打开仓库查看 |
...
已更新 · 最近成功抓取: 2026-09-22T03:22:56Z
...
已更新 · 最近成功抓取: 2026-09-22T03:22:59Z
...
已更新 · 最近成功抓取: 2026-09-22T03:23:00Z
...
- jev in:name,description fork:false archived:false stars:&gt;=2 — 200 / 1063（达到页数上限）
- topic:jev fork:false archived:false — 200 / 1096（达到页数上限）
