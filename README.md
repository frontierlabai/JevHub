...
| 🥈 [OpenByteInc/QuantDinger](https://github.com/OpenByteInc/QuantDinger) | 应用 / 集成 | **11,952** | Open-source AI Trading OS, agent trading, and vibe trading, with Jev System One integration. Resear… |
...
| 21 [rmalde/minecraft-agent](https://github.com/rmalde/minecraft-agent) | 应用 / 集成 | **480** | Astra planner and JEV controller for Minecraft, with native recording, tested routes, and run verif… |
...
| 26 [kerpopule/hermes-jev-skills](https://github.com/kerpopule/hermes-jev-skills) | 开发工具 | **399** | Jev-powered model routing, memory, compaction, skill selection, computer and browser use for Hermes… |
