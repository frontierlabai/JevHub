...
| :-- | :-- | --: | --: | :-- |
| 🥇 [browser-use/jev-ultrafast](https://github.com/browser-use/jev-ultrafast) | 应用 / 集成 | **16,148** | — | 浏览器 Agent：由 Jev 选择页面操作，结合文本生成模型完成任务。 |
| 🥈 [OpenByteInc/QuantDinger](https://github.com/OpenByteInc/QuantDinger) | 应用 / 集成 | **11,955** | — | Open-source AI Trading OS, agent trading, and vibe trading, with Jev System One integrati… |
| 🥉 [NandhaKishorM/laya](https://github.com/NandhaKishorM/laya) | 独立复现 / 研究 | **11,153** | — | 独立开放决策模型，提供训练与评测材料；非 TypeSafe 官方模型。 |
| 4 [tamaratran/fast-jev-compaction](https://github.com/tamaratran/fast-jev-compaction) | 开发工具 | **6,020** | — | Claude Code 上下文压缩插件：Jev 判断哪些工具记录仍需保留。 |
| 5 [TheoLeeCJ/SemIf](https://github.com/TheoLeeCJ/SemIf) | 独立复现 / 研究 | **3,327** | — | 用开放模型实现语义判断，原名 OpenJev；项目明确声明与 TypeSafe 无关联。 |
| 6 [jaredpalmer/kev](https://github.com/jaredpalmer/kev) | 独立复现 / 研究 | **2,577** | — | 基于 Qwen3.5 的独立 Jev-like 决策模型，可自行训练；非官方模型。 |
...
| 8 [TianyuCodings/NanoJev](https://github.com/TianyuCodings/NanoJev) | 独立复现 / 研究 | **1,839** | — | 独立小型复现：并行决策、动态候选与训练流程；非官方模型。 |
| 9 [typesafe-ai/skills](https://github.com/typesafe-ai/skills) | 官方项目 | **1,584** | — | 官方 Agent skills：设计和构建 System One 决策工作流。 |
| 10 [jev-chat/jev-chat-jarvis](https://github.com/jev-chat/jev-chat-jarvis) | 应用 / 集成 | **1,480** | — | 中文手机聊天助手：Jev 判断意图和风险，辅助选择回复。 |
...
| 20 [devagrawal09/jev-review](https://github.com/devagrawal09/jev-review) | 开发工具 | **498** | — | 基于 Jev 的分阶段代码审查与本地结果面板。 |
| 21 [rmalde/minecraft-agent](https://github.com/rmalde/minecraft-agent) | 应用 / 集成 | **481** | — | Astra planner and JEV controller for Minecraft, with native recording, tested routes, and… |
| 22 [thruwire/foreman](https://github.com/thruwire/foreman) | 应用 / 集成 | **469** | — | Software factory foreman based on TypeSafe's Jev model |
| 23 [featherless-ai/simple-jev](https://github.com/featherless-ai/simple-jev) | 独立复现 / 研究 | **457** | — | 将开放模型转换为分类器与 Jev 风格接口；独立实现。 |
...
| 28 [wuyoscar/jev-skill](https://github.com/wuyoscar/jev-skill) | 资源合集 | **374** | — | An awesome collection of Jev use cases, workflows, and agent skills. |
| 29 [wfzyx/von](https://github.com/wfzyx/von) | 独立复现 / 研究 | **370** | — | 独立开放决策模型，提供 TypeSafe API 兼容接口；非官方模型。 |
